...
public class JetMinionsPlaceTaskType extends BukkitTaskType {

    private final BukkitQuestsPlugin plugin;

    public JetMinionsPlaceTaskType(BukkitQuestsPlugin plugin) {
        super("jetminions_placeminion", TaskUtils.TASK_ATTRIBUTION_STRING, "Place down a set of minions.");
        this.plugin = plugin;

        super.addConfigValidator(TaskUtils.useRequiredConfigValidator(this, "type"));
    ...
    public void onNPCClick(PostMinionPlaceEvent event) {
        ...
        for (TaskUtils.PendingTask pendingTask : TaskUtils.getApplicableTasks(player, qPlayer, this)) {
            ...
            Object typeObj = task.getConfigValue("type");
            String type = "";
