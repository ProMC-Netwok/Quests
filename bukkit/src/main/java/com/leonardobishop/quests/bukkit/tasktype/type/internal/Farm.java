...
public final class Farm extends BukkitTaskType {

    private final BukkitQuestsPlugin plugin;

    public Farm(BukkitQuestsPlugin plugin) {
        ...
        try {
            ...
            plugin.getServer().getPluginManager().registerEvents(new Farm.HarvestBlockListener(), plugin);
        } catch (ClassNotFoundException ignored) {
        } // server version cannot support event
